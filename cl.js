...
function VectorAdd() {
	...
	var size = BUFFER_SIZE * BUFFER_SIZE * Uint32Array.BYTES_PER_ELEMENT; // size in bytes
	...
	var dBuffer = cl.createBuffer(context, cl.MEM_WRITE_ONLY, size);
	...
	cl.setKernelArg(kernel, 3, 'uint*', dBuffer);
	cl.setKernelArg(kernel, 4, 'uint', BUFFER_SIZE);
